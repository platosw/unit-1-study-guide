...
def duplicates(items):
    ...
    #         if items[x] == items[y]:
    #             if not items[x] in duplicates:
    #                 duplicates.append(items[x])
...
def find_letter_indices(words, letter):
    ...
    **DO NOT** use the `list.index()` method.
    ...
    for idx, word in enumerate(words):
        if letter in word:
            find_letter_indices.append(idx)
        else:
            find_letter_indices.append(None)
